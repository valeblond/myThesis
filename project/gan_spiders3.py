...
class Discriminator(nn.Module):
    ...
    def __init__(self, conv_dim=128):
        ...
        # 16x16 out
        self.conv4 = conv(conv_dim*4, conv_dim*4*2, 4)
        # 8x8 out
        self.conv5 = conv(conv_dim*4*2, conv_dim*4*2, 4)
        # 4x4 out
        
        # final, fully-connected layer
        self.fc = nn.Linear(conv_dim*4*2*4*4, 1)
    ...
    def forward(self, x):
        ...
        # flatten
        out = out.view(-1, self.conv_dim*4*2*4*4)
...
class Generator(nn.Module):
    ...
    def __init__(self, z_size, conv_dim=128):
        ...
        self.fc = nn.Linear(z_size, conv_dim*4*2*4*4)

        # transpose conv layers
        self.t_conv1 = deconv(conv_dim*4*2, conv_dim*4*2, 4)
        self.t_conv2 = deconv(conv_dim*4*2, conv_dim*4, 4)
    ...
    def forward(self, x):
        ...
        out = self.fc(x)
        out = out.view(-1, self.conv_dim*4*2, 4, 4) # (batch_size, depth, 4, 4)
